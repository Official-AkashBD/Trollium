    ...
    return (
      <Main className={classes.root}>
        <article>
          <Secuence stagger>
            <header>
              <h1><Text>About The Handler's Hub</Text></h1>
            </header>
            <p><Text>Welcome to the Handler's Hub. This is a digital hub on the web where Lancers find jobs from Handlers, connect with other Lancers, form alliances, and exchange intel. The Handler's Hub allows Lancers to sort jobs by urgency, difficulty, payout, job type, Handler Reputation, and location.</Text></p>
            <Fader>
              <img src={joshMullisImageURL} alt="Josh Mullis's photo" />
            </Fader>
            <p><Text> Below are some terms that may be unfamiliar for newcomers to the hub. Familizarize yourself with these terms before interacting wtih the rest of the Hub.</Text></p>
            <Link
